...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("graphics/2.png", __ASSET__graphics_2_png);
		type.set ("graphics/2.png", AssetType.IMAGE);
		className.set ("graphics/4.png", __ASSET__graphics_4_png);
		type.set ("graphics/4.png", AssetType.IMAGE);
		className.set ("graphics/3.png", __ASSET__graphics_3_png);
		type.set ("graphics/3.png", AssetType.IMAGE);
		className.set ("graphics/0.png", __ASSET__graphics_0_png);
		type.set ("graphics/0.png", AssetType.IMAGE);
		className.set ("graphics/5.png", __ASSET__graphics_5_png);
		type.set ("graphics/5.png", AssetType.IMAGE);
		className.set ("graphics/1.png", __ASSET__graphics_1_png);
		type.set ("graphics/1.png", AssetType.IMAGE);
		className.set ("graphics/7.png", __ASSET__graphics_7_png);
		type.set ("graphics/7.png", AssetType.IMAGE);
		className.set ("graphics/6.png", __ASSET__graphics_6_png);
		type.set ("graphics/6.png", AssetType.IMAGE);
...
@:keep @:bind #if display private #end class __ASSET__graphics_2_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__graphics_4_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__graphics_3_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__graphics_0_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__graphics_5_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__graphics_1_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__graphics_7_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__graphics_6_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/graphics/2.png") #if display private #end class __ASSET__graphics_2_png extends lime.graphics.Image {}
@:image("assets/graphics/4.png") #if display private #end class __ASSET__graphics_4_png extends lime.graphics.Image {}
@:image("assets/graphics/3.png") #if display private #end class __ASSET__graphics_3_png extends lime.graphics.Image {}
@:image("assets/graphics/0.png") #if display private #end class __ASSET__graphics_0_png extends lime.graphics.Image {}
@:image("assets/graphics/5.png") #if display private #end class __ASSET__graphics_5_png extends lime.graphics.Image {}
@:image("assets/graphics/1.png") #if display private #end class __ASSET__graphics_1_png extends lime.graphics.Image {}
@:image("assets/graphics/7.png") #if display private #end class __ASSET__graphics_7_png extends lime.graphics.Image {}
@:image("assets/graphics/6.png") #if display private #end class __ASSET__graphics_6_png extends lime.graphics.Image {}
